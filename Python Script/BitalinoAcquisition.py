...
class GUI:
    ...
    def __init__(self,inlet):
        ...
        self.buttonCalibration = tk.Button(self.root,text="Launch Calibration",command = self.calibration)
        self.buttonCalibration.pack(padx=20,pady=10)

        self.buttonStart = tk.Button(self.root, text="Start Server", command = self.start_server)
